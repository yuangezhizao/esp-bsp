...
/**
 * @file
 * @brief ESP BSP: ESP-SparkBot-45coll
 */
 ...
 *  @{
 */
#define BSP_BOARD_ESP_SPARKBOT_45COLL
/** @} */ // end of boardname
...
#define BSP_I2S_DIN (GPIO_NUM_NC)
/** @} */ // end of audio
 ...
 *  @{
 */
#define BSP_LCD_SPI_MOSI (GPIO_NUM_47)  // EXAMPLE_LCD_GPIO_MOSI
#define BSP_LCD_SPI_CLK (GPIO_NUM_21)   // EXAMPLE_LCD_GPIO_SCLK
#define BSP_LCD_SPI_CS (GPIO_NUM_46)    // EXAMPLE_LCD_GPIO_CS
#define BSP_LCD_DC (GPIO_NUM_43)        // EXAMPLE_LCD_GPIO_DC
#define BSP_LCD_RST (GPIO_NUM_NC)       // EXAMPLE_LCD_GPIO_RST
#define BSP_LCD_BACKLIGHT (GPIO_NUM_44) // EXAMPLE_LCD_GPIO_BL
/** @} */                               // end of display
 ...
 * Camera interface
 *
 * ESP-SparkBot-45coll is shipped with OV2640 camera module.
 ...
 **************************************************************************************************/
/**
 * @brief ESP-SparkBot-45coll camera default configuration
 *
 ...
 * LCD interface
 *
 * ESP-SPARKBOT-45COLL is shipped with 1.3inch ST7789 display controller.
 ...
 **************************************************************************************************/
#define BSP_LCD_PIXEL_CLOCK_HZ (80 * 1000 * 1000) // (40 * 1000 * 1000) EXAMPLE_LCD_PIXEL_CLK_HZ
#define BSP_LCD_SPI_NUM (SPI3_HOST)               // EXAMPLE_LCD_SPI_NUM

#if (BSP_CONFIG_NO_GRAPHIC_LIB == 0)
#define BSP_LCD_DRAW_BUFF_SIZE (BSP_LCD_H_RES * BSP_LCD_V_RES) // EXAMPLE_LCD_DRAW_BUFF_HEIGHT
#define BSP_LCD_DRAW_BUFF_DOUBLE (0)                           // EXAMPLE_LCD_DRAW_BUFF_DOUBLE
