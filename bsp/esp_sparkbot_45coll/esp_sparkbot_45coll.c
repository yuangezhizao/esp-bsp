...
#include "bsp/esp_sparkbot_45coll.h"
#include "bsp_err_check.h"
#include "bsp/display.h"
#include "button_gpio.h"
#include "button_adc.h"

static const char *TAG = "ESP-SPARKBOT-45COLL";
...
static const bsp_button_config_t bsp_button_config[BSP_BUTTON_NUM] = {
    {.type = BSP_BUTTON_TYPE_ADC,
     .cfg.adc = {
         ...
         .max = 2510}},
    {.type = BSP_BUTTON_TYPE_ADC, .cfg.adc = {.adc_handle = &bsp_adc_handle,
                                              .adc_channel = ADC_CHANNEL_0, // ADC1 channel 0 is GPIO1
    ...
    {.type = BSP_BUTTON_TYPE_ADC, .cfg.adc = {.adc_handle = &bsp_adc_handle,
                                              ...
                                              .max = 480}},
    {.type = BSP_BUTTON_TYPE_GPIO, .cfg.gpio = {.active_level = 0, .gpio_num = BSP_BUTTON_BOOT_IO}}};
...
#define LCD_CMD_BITS (8)                                      // EXAMPLE_LCD_CMD_BITS
#define LCD_PARAM_BITS (8)                                    // EXAMPLE_LCD_PARAM_BITS
#define LCD_LEDC_CH (CONFIG_BSP_DISPLAY_BRIGHTNESS_LEDC_CH)   // LEDC_CHANNEL
#define LVGL_TICK_PERIOD_MS (CONFIG_BSP_DISPLAY_LVGL_TICK)    // EXAMPLE_LVGL_TICK_PERIOD_MS
#define LVGL_MAX_SLEEP_MS (CONFIG_BSP_DISPLAY_LVGL_MAX_SLEEP) // EXAMPLE_LVGL_TASK_MAX_DELAY_MS
...
esp_err_t bsp_display_new(const bsp_display_config_t *config, esp_lcd_panel_handle_t *ret_panel, esp_lcd_panel_io_handle_t *ret_io)
{
    ...
    const esp_lcd_panel_io_spi_config_t io_config = {
        ...
        .spi_mode = 0, // Note: SPI Mode 2 causes black screen with no display output
...
lv_display_t *bsp_display_start(void)
{
    bsp_display_cfg_t cfg = {
        .lvgl_port_cfg = {
            ...
            .task_stack = 6144,                     // EXAMPLE_LVGL_TASK_STACK_SIZE
            .task_affinity = 1,                     // EXAMPLE_LVGL_TASK_AFFINITY
            .timer_period_ms = LVGL_TICK_PERIOD_MS, // EXAMPLE_LVGL_TICK_PERIOD_MS
            .task_max_sleep_ms = LVGL_MAX_SLEEP_MS, // EXAMPLE_LVGL_TASK_MAX_DELAY_MS
        },
        .buffer_size = BSP_LCD_DRAW_BUFF_SIZE,     // EXAMPLE_LCD_DRAW_BUFF_HEIGHT
        .double_buffer = BSP_LCD_DRAW_BUFF_DOUBLE, // EXAMPLE_LCD_DRAW_BUFF_DOUBLE
        .flags = {
